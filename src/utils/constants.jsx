...
export const USER_API = {
  ...
  GET_ADMIN_BANK_DETAILS: "users/get_admin_bank_details.php",
  ...
  ADD_REMARK_CREATE_SUPPORT_TICKET: "support_ticket/create_support_ticket.php", // pending by backend now this is old URL 
